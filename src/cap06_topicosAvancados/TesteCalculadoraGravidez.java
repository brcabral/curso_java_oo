...
public class TesteCalculadoraGravidez {
	public static void main(String[] args) {
		new TesteCalculadoraGravidez();
	}

	public TesteCalculadoraGravidez() {
	...
	private String formatarData(Date data) {
		...
		// A classe Locale representa uma região no planeta,
		// sendo neste caso o Brasil (br), onde falamos Português (pt)
